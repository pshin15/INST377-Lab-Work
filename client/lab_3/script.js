...
function updateSlidePosition() {
  slidesArray.forEach((slide) => {
    slide.classList.remove('visible');  // and remove the 'visible' class from each classList
    slide.classList.add('hidden');  // then add a class 'hidden' to all of them
  });

  console.log(slidePosition);
  // outside your .forEach,
  slides[slidePosition].classList.add('visible'); // use current slide position to put us at the right index for which slide should be visible
